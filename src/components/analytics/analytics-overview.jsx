...
import { printElementToPDF } from "@/lib/print-pdf"; // ✅ print-to-pdf helper
...
export default function AnalyticsOverview() {
  ...
  const exportExcelFile = async () => {
    await downloadExcel(`analytics-${from}-to-${to}`, buildRows(), "Transactions");
  };
...
const exportPDF = () => {
  ...
  requestAnimationFrame(() => {
    setTimeout(() => {
      printElementToPDF(exportRef.current, `analytics-${from}-to-${to}`);
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      ...
      <div ref={exportRef} id="analytics-export">
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div className="flex items-center gap-2 no-print">
                  ...
                  <ExportDropdown
                    onCSV={exportCSV}
                    onExcel={exportExcelFile}
                    onPrint={exportPDF} // ✅ Print-to-PDF
                  />
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setDialogFilters({ categoryIds: [], min: "", max: "" })
                    }
                  >
                    Reset
                  </Button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <AnalyticsMonthlyBars filters={filters} transactions={filteredTx} exporting={exporting} />
          <AnalyticsCategoryPie filters={filters} transactions={filteredTx} exporting={exporting}  />
        </div>

        <AnalyticsNetTrend filters={filters} transactions={filteredTx} exporting={exporting}  />
